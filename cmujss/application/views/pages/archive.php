...
<div style="background-color: white !important;"class="space-sm bg-light-subtle" id="home">
    ...
    <?php if (!empty($grouped_articles)): ?>
        <?php foreach ($grouped_articles as $volumeid => $volume_data): ?>
            <div class="volume-group">
                <br>
                <h3><?php echo $volume_data['volume_name']; ?></h3>
                <?php if (!empty($volume_data['articles'])): ?>
                    <?php foreach ($volume_data['articles'] as $article): ?>
                        <div class="card mb-2">
                            <div class="card-body">
                    ...
                    <?php endforeach; ?>
                <?php else: ?>
                    <p>No articles published in this volume.</p>
                <?php endif; ?>
            </div>
        <?php endforeach; ?>
    <?php else: ?>
        <p>No articles archived.</p>
    <?php endif; ?>
</div>
    </div>
                </div>
