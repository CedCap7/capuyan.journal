      ...
      <div class="col-lg-4 col-xlg-3 col-md-5">
        <div class="card">
          <div class="card-body text-center">
            <center class="mt-3">
				<img src="<?php echo site_url(); ?>assets/images/users/<?php echo $author['images']; ?>" class='rounded-circle' width='250'>
            </center>
            <h4 class="card-title mt-2" style="font-size: 18px;"><?php echo $author['author_name']; ?></h4>
